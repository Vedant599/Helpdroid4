...
//Checking if the string is empty or not...
                ...
                if(userEmail.equals("")){
                    ...
                    Toast.makeText(Forgot_Password.this,"Please enter the email id...",Toast.LENGTH_SHORT).show();
                    ...
                    firebaseAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(Forgot_Password.this,"Password Reset Email sent Successful...",Toast.LENGTH_SHORT).show();
...
//finish();
                                ...
                                Toast.makeText(Forgot_Password.this,"Please check your network...",Toast.LENGTH_SHORT).show();
