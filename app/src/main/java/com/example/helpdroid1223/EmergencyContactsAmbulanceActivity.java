...
public class EmergencyContactsAmbulanceActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_contacts_ambulance);
        client = LocationServices.getFusedLocationProviderClient(this);
        locationManager =(LocationManager) getSystemService(Context.LOCATION_SERVICE);
        //panic = (ImageButton) findViewById(R.id.panicbtn);
        permission_check1 = ContextCompat.checkSelfPermission(EmergencyContactsAmbulanceActivity.this,Manifest.permission.CALL_PHONE);
        permission_check2=ContextCompat.checkSelfPermission(EmergencyContactsAmbulanceActivity.this,Manifest.permission.SEND_SMS);
        permission_check3 = ContextCompat.checkSelfPermission(EmergencyContactsAmbulanceActivity.this,Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    private String myLocation() {
        ...
        if(permission_check3==PackageManager.PERMISSION_GRANTED) {
          /*  client.getLastLocation().addOnSuccessListener(EmergencyContactsAmbulanceActivity.this, new OnSuccessListener<Location>() {
                @Override
        ...
        {
            ActivityCompat.requestPermissions(EmergencyContactsAmbulanceActivity.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},2);
            loc ="Hello";
        }
        return loc;
    }

    public EmergencyContactsAmbulanceActivity() {
    }
